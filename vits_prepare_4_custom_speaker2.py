...
if __name__ == "__main__":
    ...
    fo = open(hps.data.origin_training_files, "r", encoding='utf-8')
    scrips = []
    while (True):
        try:
        ...
        message = message.replace("——", "...")\
            ...
            .replace('”', '"')\
            .replace("\n", "")
        pinyins = pypinyin.lazy_pinyin(message, style=pypinyin.TONE3, neutral_tone_with_five=True, errors='ignore')
